<!-- Proposal snapshot, frozen 2026-07-30. Authored by Claude
     (Fable 5) working in the vc-x1 repo; companion discussion
     file: AGENTS-vc-x1-f5-20260730-notes.md. The live, evolving
     copy is vc-x1's AGENTS.md during the 0.78.0 dogfood
     window; this snapshot is frozen for discussion. Below this
     comment is that file verbatim as adopted. -->
